...
{
    public partial class frmModificarCalifiServicio : Form
    {
        ...
        public frmModificarCalifiServicio(int idServ)
        {
        ...
        private void frmModificarCalifiServicio_Load(object sender, EventArgs e)
        {
            trackBar1.Minimum = 0;
            trackBar1.Maximum = 5;
